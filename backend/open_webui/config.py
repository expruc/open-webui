...
USER_PERMISSIONS_CHAT_ALLOW_ATTACH_FILES_FROM_KNOWLEDGE = (
    os.getenv("USER_PERMISSIONS_CHAT_ALLOW_ATTACH_FILES_FROM_KNOWLEDGE", "True").lower()
    == "true"
)
...
DEFAULT_USER_PERMISSIONS = {
    ...
    "chat": {
        ...
        "allow_attach_files_from_knowledge": USER_PERMISSIONS_CHAT_ALLOW_ATTACH_FILES_FROM_KNOWLEDGE,
    },
    "features": {
